...
public class HomeActivity extends FragmentActivity implements GestureDetector.OnGestureListener,
    ...
    private void updateSwipes() {
        ...
        if(mSwipes !=0 && (mSwipes%4 == 0))
        {
                    ...
                    switch (which){
                        case DialogInterface.BUTTON_POSITIVE:
                            ...
                            BoomVideoResourceManager boomVideoResourceManager = BoomVideoResourceManager
                                    .getInstance();
                            boomVideoResourceManager.showVideoAds(BOOMGUID,HomeActivity.this,
            ...
            builder.setMessage("Level 1 completed. Do you want to go to next level?").setPositiveButton("Yes", dialogClickListener)
    ...
    public void onVideoTrackEvent(final OperationResult operationResult) {
        switch (operationResult.getResultMessages()) {
            ...
            case AD_VIEW_CLOSED:
                ...
                HomeActivity.this.setTitle("Level 2");
                break;
            default:
                break;
        }
