...
public class MainActivity extends Activity implements BoomVideoTrackerInf {
            ...
            public void onClick(View v) {
                ...
                if (validateGuid()) {
                    ...
                    boomVideoResourceManager.showVideoAds(Boom_GUID,
                    		MainActivity.this, BoomVideoResourceManager.VIDEO_PLAYER_TYPE.PREROLL);
                }
            }
        });
            ...
            public void onClick(View v) {
                if (validateGuid()) {
                    ...
                    boomVideoResourceManager
                            .showVideoAds(
                                    Boom_GUID,
                                    MainActivity.this, BoomVideoResourceManager.VIDEO_PLAYER_TYPE.REWARDS);
                }
            }
        });
            ...
            public void onClick(View v) {
                if (validateGuid()) {
                    BoomVideoResourceManager boomVideoResourceManager = BoomVideoResourceManager
                            .getInstance();
                    boomVideoResourceManager.showVideoAds(Boom_GUID,
                    		MainActivity.this, BoomVideoResourceManager.VIDEO_PLAYER_TYPE.OFFLIST);
                }
            }
        });
    ...
    public void onVideoTrackEvent(final OperationResult operationResult) {
        switch (operationResult.getResultMessages()) {
            ...
            case BLOG_URL:
                ...
                Toast.makeText(MainActivity.this, "BLOG_URL- " + operationResult.getPoints(),
                        Toast.LENGTH_SHORT).show();
                break;
            case APP_INSTALLED:
...
//                            Toast.LENGTH_SHORT).show();
            ...
            case INTERSTITIAL_CLOSED:
                ...
                break;
            case AD_VIEW_LOADED:
            	//Toast.makeText(MainActivity.this, "ad view loaded", Toast.LENGTH_SHORT).show();
            	break;
            	
            case AD_VIEW_CLOSED:
            	//Toast.makeText(MainActivity.this, "ad view closed", Toast.LENGTH_SHORT).show();
            	break;
            default:
                break;
        }
